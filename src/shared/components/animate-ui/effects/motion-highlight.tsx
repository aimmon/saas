...
function MotionHighlightComponent<T extends string>({
  ref,
  ...props
}: MotionHighlightProps<T> & { ref?: React.Ref<HTMLDivElement> }) {
  const {
    children,
    value,
    defaultValue,
...
const MotionHighlightItem = ({
  ...
  forceUpdateBounds,
  ...props
}: MotionHighlightItemProps & { ref?: React.RefObject<HTMLDivElement | null> }) => {
